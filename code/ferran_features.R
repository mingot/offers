UserFeatures = function(TRANS,TRAIN){
  # ================================================================================ #  
  # OUTPUT
    # freq: times/month user goes shopping
    # freq_last_3: times/month user goes shopping during the last 3 months
    # aov = average order value
    # freq_category: frequency by category
    # freq_product: frequency by product
    # regularity: st.dev time between purchases
  # ================================================================================ #
